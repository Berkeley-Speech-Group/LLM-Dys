...
def process_data(start_id, end_id, gpu_id, json_path, base_output_dir):
    ...
    for speaker_id in range(0, 109): 
        ...
        final_json = os.path.join(info_dir, 'phn_pau.json')
        ...
        for item in filtered_data:
            try:
                ...
                print(f"success: speaker_{speaker_id:03d}/{item['id']}.wav")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json', type=str, default=f"/set your path/LLM-Dys/labels/phn_pau.json")
    parser.add_argument('--output', type=str, default=f"/your path to save the dataset/LLM_dys/phn/phn_pau_original")

...
def run_pau_add(start_id, end_id, speaker_id, config):
    ...
    ############################################################################################################
    json_path = os.path.join(speaker_input, "information/phn_pau.json")    # phn_pau/ word_pau
...
python /set your path/LLM-Dys/data_simulation/vits/phoneme_level/batch_pau_add.py \
    --start_id 1 \
    --end_id 13000 \
    --start_speaker 0 \
    --end_speaker 108 \
    ...
    --max_workers 64 \
    --interval 0.01\
    --script_path /set your path/LLM-Dys/data_simulation/vits/phoneme_level/pau_add_phn.py \
    --audio_dir /set your path/LLM_dys/phn/phn_pau_original \
    --output_dir /set your path/LLM_dys/phn/phn_pau \
    --crossfade_ms 50
